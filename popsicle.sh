...
deploy () {
	...
	sudo apt update
	sudo apt install gnome-software gnome-software-plugin-flatpak timeshift waydroid -y;
	sudo apt autoremove libreoffice-math libreoffice-writer libreoffice-impress libreoffice-calc libreoffice-draw snapd gnome-software-plugin-snap pop-shop -y
